...
<html>
<head>
    <title>Update Asset Rental Processing</title>
    <style>
            body {
                font-family: Arial;
...
<div>
    <h3>Update Asset Rental Form</h3>
    <form action="index.jsp">
        ...
        %>
        <h1>Asset Rental Info Updated Successfully!</h1>
        <% } else { %>
        <h1>Asset Rental Info Update Failed!</h1>
